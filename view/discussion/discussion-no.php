...
<section class="section">
    <div class="container">
        ...
        <?php } else if ($resRep['idDiscussion'] === $show['idDiscussion']) { ?>
            <div class="row align-items-center mb-5">
                <div class="col-lg-9">
                    <ul class="list-inline">
                        <li class="list-inline-item mr-xl-5 mr-4 mb-3 mb-lg-0">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 mb-4 mb-lg-0">
                    <div class="media">
                        <img class="mr-3 img-fluid" src="/e5_php/style/images/event-speakers/speaker-1.jpg"
                             alt="speaker">
                        <div class="media-body">
                            <h4 class="mt-0"><?php
                                if (isset($resRep['idCreateurEleve'])) {
                                    echo $resRep['idCreateurEleve'];
                                }
                                if (isset($resRep['idCreateurProf'])) {
                                    echo $resRep['idCreateurProf'];
                                }
                                if (isset($resRep['idCreateurParent'])) {
                                    echo $resRep['idCreateurParent'];
                                } ?></h4>
                        </div>
                    </div>
                </div>
