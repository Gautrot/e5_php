    ...
    <div class="navigation w-100">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                <a class="navbar-brand" href="/e5_php/index"><img src="/e5_php/style/images/logoLPRS1.jpg" alt="logo"></a>
                    ...
                    <ul class="navbar-nav ml-auto text-center">
                        ...
                        <li class="nav-item dropdown view">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <?php } else if (isset($_SESSION['user'])) { ?>
                                    ...
                                    <a class="dropdown-item" href="/e5_php/view/profil">Voir votre profil</a>
                                    <a class="dropdown-item" href="/e5_php/view/modif-util">Modifier
                                        votre compte</a>
                                    ...
                                    <a class="dropdown-item" href="/e5_php/view/evenement/evenements">Évènements</a>
                                    <a class="dropdown-item" href="/e5_php/view/deconnexion">Déconnexion</a>
                                <?php } ?>
                            </div>
                        </li>
                        <li class="nav-item @@contact">
                            <a class="nav-link" href="/e5_php/view/contact">Contact</a>
                        </li>
                        <?php if (isset($_SESSION['user']['statut']) && $_SESSION['user']['statut'] === '4') { ?>
                            <li class="nav-item dropdown view">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/e5_php/view/admin/table-util">Liste d'utilisateurs</a>
                                </div>
                            </li>
                        <?php } ?>
                    </ul>
