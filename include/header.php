                                ...
                                <?php } else if (isset($_SESSION['user'])) { ?>
                                    ...
                                    <?php switch ($_SESSION['user']['statut']) {
                                        ...
                                        case '4':
                                            ?>
                                            <a class="dropdown-item" href="/e5_php/view/discussion/discussions.php">Discussion</a>
                                            <a class="dropdown-item" href="/e5_php/view/pee/pee.php">Projets éducatifs de l’établissement</a>
                                            <a class="dropdown-item" href="/e5_php/view/rdv/rdv.php">Rendez-vous</a>
                                            <?php break;
                                    } ?>
                                    <a class="dropdown-item" href="/e5_php/view/evenement/evenements.php">Évènements</a>
                                    <a class="dropdown-item" href="/e5_php/view/deconnexion.php">Déconnexion</a>
                                <?php } ?>
                            </div>
                        </li>
