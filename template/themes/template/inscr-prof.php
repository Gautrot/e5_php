    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <p class="text-lighten">Inscrivez-vous sur le site en tant que professeur.</p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="modal-body">
                    <div class="login">
                        <form method="POST" action="/e5_php/traitement/prof/inscription-tr.php" style="width:100%">
                            ...
                            <div class="form-group">
                                <label for="metier">Matiere</label>
                                <input type="text" class="form-control form-control-sm mb-3" id="matiere" name="matiere"
